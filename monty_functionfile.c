#include "monty.h"
/**
 * myread_file - reads a bytecode file and runs commands
...
/**
 * get_op_functions -  checks opcode and returns the correct function
 * @str: the opcode
...
/**
 * myparse_line - parses a line for an opcode and arguments
